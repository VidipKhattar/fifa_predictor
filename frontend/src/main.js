      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-4 sm:m-5">
        ...
        <p className="text-gray-400">
          <span className="block md:hidden text-sm">
            Analyze your favorite songs to predict their likelihood of being in
            the next FIFA. Upload/Search a song to see its potential!
          </span>
          ...
          <span className="hidden lg:block xl:hidden">
            ...
            the next FIFA/EA FC game. Upload/Search a song, and our advanced
            machine learning model will provide a probability score indicating
            its potential to become a FIFA soundtrack hit.
          </span>
          <span className="hidden xl:block">
            Welcome to FIFA Song Predictor, an innovative web app that analyzes
            your favorite songs to predict their likelihood of being featured in
            the next FIFA/EA FC game. Search/Upload a song, and our advanced
            machine learning model will provide a probability score indicating
            its potential to become a FIFA soundtrack hit. Try it out and see if
            your favorite tune has what it takes to make the cut!
          </span>
        </p>
      </div>
            ...
            {songResponse !== null && (
              <div>
                ...
                <p className="m-5">
                  ...
                  analysed and their FIFA likelyhood
                </p>
              </div>
            )}
